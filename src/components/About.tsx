...
import myimage from './images/alok.jpg';
import myPDF from './images/GeneralisedCV.pdf';
...
const About: React.FC = () => {
  ...
  <span className="text-white font-bold text-sm md:text-base text-center">3rd Year</span>
          ...
          >
            ...
            Hi, I'm Alok Kumar —
An enthusiastic B.Tech student specializing in Computer Science and Engineering, driven by a deep curiosity for technology and a passion for solving complex problems. I enjoy turning ideas into efficient code and have hands-on experience with languages like C, Python, and SQL. I’m constantly exploring innovative solutions that can make a real-world impact through the power of tech.
            </p>
